...
class SelectTest < Minitest::Test
  ...
  def test_pick_dinosaurs
    ...
    dinosaurs = animals.select do |anim|
      anim if anim.length > 7
    end
  ...
  def test_pick_arrays
    ...
    arrays = elements.select do |arr|
      arr if arr.class == Array.new.class
    end
  ...
  def test_pick_hashes
    ...
    hashes = elements.select do |hash|
      hash if hash.class == Hash.new.class
    end
